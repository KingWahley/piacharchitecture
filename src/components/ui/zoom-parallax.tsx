...
function ProjectSlider({ images, isVisible }: { images: ImageItem[]; isVisible: boolean }) {
          ...
          >
            ...
            {(img.title || img.description) && (
              <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/85 via-black/45 to-transparent px-6 pb-20 pt-20 md:px-12 md:pb-24 md:pt-40 text-white flex flex-col items-start">
                {img.title && (
                  <h3 className="mb-8 text-xl sm:text-3xl md:text-4xl font-[var(--font-playfair-display)] font-semibold tracking-wide leading-tight drop-shadow-md">
                    {img.title}
                  </h3>
                )}
                <a
        ...
        {isVisible && (
          <>
            <motion.button 
              ...
              className="absolute left-4 top-1/2 z-20 flex h-12 w-12 items-center justify-center rounded-full bg-white text-black shadow-lg transition-colors hover:bg-gray-200 md:left-8 md:h-16 md:w-16"
            >
            ...
            <motion.button 
              ...
              className="absolute right-4 top-1/2 z-20 flex h-12 w-12 items-center justify-center rounded-full bg-white text-black shadow-lg transition-colors hover:bg-gray-200 md:right-8 md:h-16 md:w-16"
            >
